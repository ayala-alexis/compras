        ...
        <div id="loader"
            ...
            <div
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <circle cx="25" cy="25" r="20" fill="none" stroke="#dc2626" stroke-width="4"
                        stroke-dasharray="35 100" stroke-linecap="round"></circle>
                </svg>
                <span
                    style="font-weight: 600 !important; color: #dc2626 !important; font-size: 15px !important; font-family: 'Inter', sans-serif !important;">Procesando...</span>
            </div>
        </div>

        <form id="formFiltrosAprobCC" style="flex-shrink: 0;">
            <div class="header-consulta">
                <h2 class="titulo-moderno">
                    ...
                    Solicitud(es) de compra(s) pendientes de aprobar
                </h2>
