    ...
    <div class="tarjeta-consulta"
        ...
        <div id="loader"
            ...
            <div
                ...
                <span
                    style="font-weight: 600 !important; color: #10b981 !important; font-size: 15px !important; font-family: 'Inter', sans-serif !important;">Procesando...</span>
            </div>
        </div>

        <form id="formFiltrosPendienteOC" style="flex-shrink: 0;">
            <div class="header-consulta">
                <h2 class="titulo-moderno">
                    ...
                    Solicitud(es) pendiente(s) de generar Orden de Compra
                </h2>
