...
<div class="container w-100">
    <div class="tarjeta-consulta"
        ...
        <div id="loaderCat"
            ...
            <div
                style="background: #ffffff !important; padding: 30px 45px !important; border-radius: 16px !important; box-shadow: 0 15px 35px rgba(0,0,0,0.15) !important; text-align: center !important; display: flex !important; flex-direction: column !important; align-items: center !important; transform: translateY(-10%) !important; border: 1px solid #f1f5f9 !important;">
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <circle cx="25" cy="25" r="20" fill="none" stroke="#8b5cf6" stroke-width="4"
                        stroke-dasharray="35 100" stroke-linecap="round"></circle>
                </svg>
                <span
                    style="font-weight: 600 !important; color: #8b5cf6 !important; font-size: 15px !important; font-family: 'Inter', sans-serif !important;">Procesando...</span>
            </div>
        </div>

        <form id="formFiltrosAprobCategoria" style="flex-shrink: 0;">
            <div class="header-consulta">
                <h2 class="titulo-moderno">
                    <div class="icono-titulo" style="background-color: #ede9fe; color: #8b5cf6;"><i
                ...
                <div class="buscador-observacion">
                    ...
                    <input type="text" name="observacion" id="observacion_cat" placeholder="Buscar por observación..."
                        autocomplete="off">
                </div>
            </div>
                ...
                <div class="fila-filtros">
                    <div class="filtro-grupo flex-1" title="Período">
                        ...
                        <div class="filtro-control">
                            <select name="periodo" id="periodo_cat" class="form-control select2-consulta"></select>
                        </div>
                    </div>
                    ...
                    <div class="filtro-grupo flex-1-5" title="Filtro de Empresa">
                        ...
                        <div class="filtro-control">
                            <select name="empresa" id="empresa_cat" class="form-control select2-consulta">
                    ...
                    <div class="filtro-grupo flex-1-5" title="Filtro de Centro de Costos">
                        ...
                        <div class="filtro-control">
                            <select name="centroCostos" id="centroCostos_cat" class="form-control select2-consulta"
                                disabled>
                    ...
                    <div class="filtro-grupo flex-1-5" title="Filtro de Categoría">
                        <div class="filtro-icono"><i class="fas fa-tag"></i></div>
                        <div class="filtro-control">
                            <select name="categoria" id="categoria_filtro_cat" class="form-control select2-consulta">
            ...
            <table class="table-moderna">
                <thead>
                    <tr>
                        ...
                        <th>Analista / Fecha</th>
                        <th>SLA</th>
                        <th class="text-center">Adjuntos</th>
                        <th class="text-center">Acción</th>
                    </tr>
                </thead>
                <tbody id="tablaBodyAprobCategoria">
                </tbody>
            </table>
        </div>

        <div class="paginacion-moderna" style="flex-shrink: 0;">
            <div id="paginacionInfoCat" class="text-bold fw-normal">Mostrando 0 registros</div>
            <div class="pag-botones" id="paginacionBotonesCat"></div>
        </div>
