    ...
    <div class="tarjeta-consulta"
        ...
        <div id="loader"
            ...
            <div
                ...
                <span
                    style="font-weight: 600 !important; color: #6366f1 !important; font-size: 15px !important; font-family: 'Inter', sans-serif !important;">Procesando...</span>
            </div>
        </div>

        <form id="formFiltrosOC" style="flex-shrink: 0;">
            <div class="header-consulta">
                <h2 class="titulo-moderno">
                    <div class="icono-titulo" style="background-color: #eef2ff; color: #6366f1;"><i
                ...
                <div class="buscador-observacion">
                    ...
                    <input type="text" name="search" id="search" placeholder="Buscar por N° OC o Proveedor..."
                        autocomplete="off">
                </div>
            </div>
            ...
            <table class="table-moderna">
                <thead>
                    <tr>
                        ...
                        <th>Proveedor</th>
                        <th>Monto Total</th>
                        <th>Generado por / Fecha</th>
                        <th class="text-center">Estado OC</th>
                        <th class="text-center">Acción</th>
                    </tr>
                </thead>
                <tbody id="tablaBodyOC">
                </tbody>
            </table>
        </div>
